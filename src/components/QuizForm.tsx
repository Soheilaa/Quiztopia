...
const QuizForm: React.FC = () => {
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                ...
                (error) => {
                    ...
                    setDefaultPosition([59.326464, 18.0584448]); // Default location (Stockholm)
                }
            );
        } else {
            setDefaultPosition([59.326464, 18.0584448]); // Default location
        }
    }, []);
    ...
    const handleSave = (event: React.FormEvent) => {
        ...
        if (selectedLocation && question && answer) {
            ...
            console.log('Adding marker:', newMarker); // Debugging
